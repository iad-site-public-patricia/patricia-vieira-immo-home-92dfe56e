    ...
    <div>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              <div key={i} className="bg-card rounded-xl p-6 text-center border border-border/50">
                <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-terracotta-light flex items-center justify-center">
      ...
      <section className="section-padding bg-card" id="formulaire">
        <div className="container mx-auto max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 bg-background rounded-xl p-8 border border-border/50">
